...
var format_KAWASAN_STRATEGIS_PT_5 = new ol.format.GeoJSON();
var features_KAWASAN_STRATEGIS_PT_5 = format_KAWASAN_STRATEGIS_PT_5.readFeatures(json_KAWASAN_STRATEGIS_PT_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_KAWASAN_STRATEGIS_PT_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_KAWASAN_STRATEGIS_PT_5.addFeatures(features_KAWASAN_STRATEGIS_PT_5);
var lyr_KAWASAN_STRATEGIS_PT_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_KAWASAN_STRATEGIS_PT_5, 
                style: style_KAWASAN_STRATEGIS_PT_5,
                popuplayertitle: "KAWASAN_STRATEGIS_PT",
                interactive: true,
    title: 'KAWASAN_STRATEGIS_PT<br />\
    <img src="styles/legend/KAWASAN_STRATEGIS_PT_5_0.png" /> DP Pengembangan<br />\
    <img src="styles/legend/KAWASAN_STRATEGIS_PT_5_1.png" /> DPP<br />\
    <img src="styles/legend/KAWASAN_STRATEGIS_PT_5_2.png" /> FE<br />\
    <img src="styles/legend/KAWASAN_STRATEGIS_PT_5_3.png" /> KEK<br />\
    <img src="styles/legend/KAWASAN_STRATEGIS_PT_5_4.png" /> KI<br />\
    <img src="styles/legend/KAWASAN_STRATEGIS_PT_5_5.png" /> SKPT<br />'
        });
var format_PLBN_6 = new ol.format.GeoJSON();
var features_PLBN_6 = format_PLBN_6.readFeatures(json_PLBN_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PLBN_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PLBN_6.addFeatures(features_PLBN_6);
var lyr_PLBN_6 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_PLBN_6, 
                style: style_PLBN_6,
                popuplayertitle: "PLBN",
                interactive: true,
                title: '<img src="styles/legend/PLBN_6.png" /> PLBN'
            });
var format_PKSN_7 = new ol.format.GeoJSON();
var features_PKSN_7 = format_PKSN_7.readFeatures(json_PKSN_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PKSN_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PKSN_7.addFeatures(features_PKSN_7);
var lyr_PKSN_7 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_PKSN_7, 
                style: style_PKSN_7,
                popuplayertitle: "PKSN",
                interactive: true,
                title: '<img src="styles/legend/PKSN_7.png" /> PKSN'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr__03_BATAS_ADMINISTRASI_KABKOT_AR_1.setVisible(true);lyr_KawasanTransmigrasi_2.setVisible(true);lyr_KawasanPerdesaanPrioritasNasional_3.setVisible(true);lyr_TITIK_LOKPRI_KATEGORI_PT_4.setVisible(true);lyr_KAWASAN_STRATEGIS_PT_5.setVisible(true);lyr_PLBN_6.setVisible(true);lyr_PKSN_7.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr__03_BATAS_ADMINISTRASI_KABKOT_AR_1,lyr_KawasanTransmigrasi_2,lyr_KawasanPerdesaanPrioritasNasional_3,lyr_TITIK_LOKPRI_KATEGORI_PT_4,lyr_KAWASAN_STRATEGIS_PT_5,lyr_PLBN_6,lyr_PKSN_7];
...
lyr_KAWASAN_STRATEGIS_PT_5.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', 'snippet': 'snippet', });
lyr_PLBN_6.set('fieldAliases', {'Name': 'Name', 'WADMKC': 'WADMKC', 'WADMKD': 'WADMKD', 'WADMKK': 'WADMKK', 'WADMPR': 'WADMPR', });
lyr_PKSN_7.set('fieldAliases', {'PKSN': 'PKSN', 'Keterangan': 'Keterangan', });
...
lyr_KAWASAN_STRATEGIS_PT_5.set('fieldImages', {'Name': 'TextEdit', 'description': 'TextEdit', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMode': 'TextEdit', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', 'snippet': 'TextEdit', });
lyr_PLBN_6.set('fieldImages', {'Name': 'TextEdit', 'WADMKC': 'TextEdit', 'WADMKD': 'TextEdit', 'WADMKK': 'TextEdit', 'WADMPR': 'TextEdit', });
lyr_PKSN_7.set('fieldImages', {'PKSN': 'TextEdit', 'Keterangan': 'TextEdit', });
...
lyr_KAWASAN_STRATEGIS_PT_5.set('fieldLabels', {'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', 'snippet': 'no label', });
lyr_PLBN_6.set('fieldLabels', {'Name': 'no label', 'WADMKC': 'no label', 'WADMKD': 'no label', 'WADMKK': 'no label', 'WADMPR': 'no label', });
lyr_PKSN_7.set('fieldLabels', {'PKSN': 'no label', 'Keterangan': 'no label', });
lyr_PKSN_7.on('precompose', function(evt) {
